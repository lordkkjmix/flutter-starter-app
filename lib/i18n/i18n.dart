...
// ignore_for_file: constant_identifier_names, no_leading_underscores_for_local_identifiers, prefer_interpolation_to_compose_strings
...
class I18n {
  ...
  Future<I18n> load() async {
    ...
    String _data =
        await rootBundle.loadString(_PATH + '/i18n_' + _code + '.json');
